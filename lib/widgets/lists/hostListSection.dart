...
class HostListSection extends StatefulWidget {
  ...
  // Map? currencies;
  HostListSection({Key? key, this.selectedCurrency}) : super(key: key);
...
class _HostListSectionState extends State<HostListSection> {
  //List<Host> hosts = [];
  final ListHost? listHost = null;
  final AutoScrollController controller = AutoScrollController();

  int _currentFocusedIndex = 0;

  getAllHosts() {
    context.read<HostBloc>().add(GetAllHosts());
    // HostCalls.getAllHosts().then((result) {
    //   setState(() {
    //     hosts = result['list'];
    // widget.currencies!['EUR']['value'] =
    //     context.read<HostBloc>().state.listHost!.eur;
    // widget.currencies!['USD']['value'] =
    //     context.read<HostBloc>().state.listHost!.usd;
    //   });
    // });
  }
                  ...
                  itemBuilder: (BuildContext context, int index) =>
                    ...
                    child: VisibilityDetector(
                      ...
                      child: HostListItem(
                          ...
                          true,
                          state.currencies![widget.selectedCurrency]['value'],
                          state.currencies![widget.selectedCurrency]['symbol']),
                    ),
                  ),
